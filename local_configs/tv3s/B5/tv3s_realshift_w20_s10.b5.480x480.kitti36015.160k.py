_base_ = [
    ...
    '../../_base_/datasets/kitti360_480x480_clips.py',
...
model = dict(
    ...
    pretrained='3rdparty/pretrained/segformer/pytorch_model.bin',
    backbone=dict(
        type='mit_b5',
        style='pytorch'),
    decode_head=dict(
...
# optimizer
optimizer = dict(_delete_=True, type='AdamW', lr=0.000075, betas=(0.9, 0.999), weight_decay=0.01,
