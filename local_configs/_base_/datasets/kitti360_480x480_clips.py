# dataset settings
dataset_type = 'Kitti360Dataset_clips'
data_root = '/home/wangcl/data/open_video_DGSS/kitti360_sequence'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            img_dir='train/data_2d_raw',
            ann_dir='train/data_2d_semantics',
            img_suffix='.png',
            seg_map_suffix='.png',
            split='train',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='val/data_2d_raw',
        ann_dir='val/data_2d_semantics',
        img_suffix='.png',
        seg_map_suffix='.png',
        split='val',
