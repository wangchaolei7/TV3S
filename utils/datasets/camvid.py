...
class CamVidDataset_clips(CustomDataset_cityscape_clips):
    """CamVid 15-label dataset with clip sampling from sequence folders."""
    ...
    def _build_sequence_index(self):
        ...
        if missing_dirs:
            print_log(
                f'Found {len(missing_dirs)} image folders missing in CamVid',
